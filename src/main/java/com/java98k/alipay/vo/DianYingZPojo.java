...
public class DianYingZPojo implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2196837231046694253L;
	...
	private Double dianYingZongHePingFen;
	private String dianYingLeiXing;
	private String dianYingQuYu;
	private Integer jiJiangShangYing;
	private String mingZi;
	private String yanYuanDaoYanTuPian;
	...
	public Double getDianYingZongHePingFen() {
		return dianYingZongHePingFen;
	}
	public void setDianYingZongHePingFen(Double dianYingZongHePingFen) {
	...
	public Integer getJiJiangShangYing() {
		return jiJiangShangYing;
	}
	public void setJiJiangShangYing(Integer jiJiangShangYing) {
		this.jiJiangShangYing = jiJiangShangYing;
	}
	...
	public String getYanYuanDaoYanTuPian() {
		return yanYuanDaoYanTuPian;
	}
	public void setYanYuanDaoYanTuPian(String yanYuanDaoYanTuPian) {
		this.yanYuanDaoYanTuPian = yanYuanDaoYanTuPian;
	}
	@Override
	public String toString() {
		return "DianYingZPojo [dianYingID=" + dianYingID + ", dianYingMingCheng=" + dianYingMingCheng
				+ ", dianYingJieShao=" + dianYingJieShao + ", shiJian=" + shiJian + ", shiChang=" + shiChang
				+ ", dianYingTuPian=" + dianYingTuPian + ", dianYingZongHePingFen=" + dianYingZongHePingFen
				+ ", dianYingLeiXing=" + dianYingLeiXing + ", dianYingQuYu=" + dianYingQuYu + ", jiJiangShangYing="
				+ jiJiangShangYing + ", mingZi=" + mingZi + ", yanYuanDaoYanTuPian=" + yanYuanDaoYanTuPian + "]";
	}
